...
const VoteProceedView = () => {
  ...
  const handleSubmit = (event) => {
    ...
    if (validate() && active && account) {
      ...
      voteAt(id, proposals, weights, account.address).then((receipt) => {
        initialize();
        setReceipt(receipt);
      });
    }
                          ...
                          return (
                            ...
                            >
                              ...
                              <input
                                ...
                                onChange={(e) =>
                                  setWeightValue(index, e.target.value)
                                }
                                placeholder="0"
                              />
                            </div>
                    ...
                    <div className="row mt-3">
                      <div className="col-md-12">
                        {!voted && (
                          ...
                          >
                            <i className="tio-send mr-1"></i>제출하기
                          </button>
                        )}
                        {voted && (
                          <button
