            ...
            <div className="card-body">
              <div className="row">
                <div className="col-md-6 mb-2">
                  <span className="font-size-sm">
                    <i className="tio-time mr-1"></i>POSTED {item.currentTime_}
                  </span>
                </div>
              ...
              <div className="row align-items-center text-left">
                <div className="col-md-6">
                  <h4>
                    {item.ended_ && (
                      <span className="badge badge-soft-secondary p-2 mr-2">
                        투표 종료
                      </span>
                    )}
                    {!item.ended_ && !item.passed && (
                      <span className="badge badge-soft-success p-2 mr-2">
                        투표 진행중
                      </span>
                    )}
                    {!item.ended_ && item.passed && (
                      <span className="badge badge-soft-danger p-2 mr-2">
                        투표 시간 마감
                      </span>
                    )}
                    {item.name_}
