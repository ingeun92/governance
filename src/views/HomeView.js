    ...
    <div className="container">
      <div className="row">
        <div id="home-introduction" className="col-lg-12 text-center">
          ...
          <p className="mt-1">
            CURG(Crypto United Research Group)은 블록체인 연구자들이 모여 매주
            관련 연구 및 현황을 공유하는 리서치 그룹입니다.
            <br />
            CURG Governance는 CURG 그룹에서 발생하는 활동에 대한 기여도에 따라
            투표권을 지급하고 리서치 그룹의 의사결정을 투표로 결정하기 위한
            사이트입니다.
          </p>
        </div>
      </div>
